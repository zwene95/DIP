function plotObs_pIOO(setup, problem, results)
    ...
    ax1 = subplot(3,1,1); hold on; grid on;
        ...
        ylabel('X [m]','FontSize',c.FS_axes, 'Interpreter',c.interpreter);
    ...
    ax2 = subplot(3,1,2); hold on; grid on;
        ...
        ylabel('Y [m]','FontSize',c.FS_axes, 'Interpreter',c.interpreter);
        set(gca,'XMinorTick','on');
        set(gca,'YMinorTick','on');   
    ...
    ax3 = subplot(3,1,3); hold on; grid on;
        ...
        ylabel('Z [m]','FontSize',c.FS_axes, 'Interpreter',c.interpreter);
        set(gca,'XMinorTick','on');
        set(gca,'YMinorTick','on');    
