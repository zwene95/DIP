...
%% States    
    ...
    if modelOptions.observer
        observerStates = [
            ...
            % Covariance
            falcon.State('P_11'         , -inf      , +inf      , 1e-0)     % 
            falcon.State('P_12'         , -inf      , +inf      , 1e-0)     % 
            falcon.State('P_13'         , -inf      , +inf      , 1e-0)     % 
            falcon.State('P_14'         , -inf      , +inf      , 1e-0)     % 
            falcon.State('P_15'         , -inf      , +inf      , 1e-0)     % 
            falcon.State('P_16'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_21'         , -inf      , +inf      , 1e-0)     % 
            falcon.State('P_22'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_23'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_24'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_25'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_26'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_31'         , -inf      , +inf      , 1e-0)     % 
            falcon.State('P_32'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_33'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_34'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_35'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_36'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_41'         , -inf      , +inf      , 1e-0)     % 
            falcon.State('P_42'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_43'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_44'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_45'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_46'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_51'         , -inf      , +inf      , 1e-0)     % 
            falcon.State('P_52'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_53'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_54'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_55'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_56'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_61'         , -inf      , +inf      , 1e-0)     % 
            falcon.State('P_62'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_63'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_64'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_65'         , -inf      , +inf      , 1e-0)     %
            falcon.State('P_66'         , -inf      , +inf      , 1e-0)     %
        ];
    else
