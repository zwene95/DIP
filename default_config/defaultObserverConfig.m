function [ ObserverConfig ] = defaultObserverConfig()
    ...
    ObserverConfig.Std_r0       = 10;                                      % Initial radius standard deviation (seeker detection range)
    ObserverConfig.Std_r0_dot   = 20;                                       % Initial radius rate standard deviation (max Invader velocity)
